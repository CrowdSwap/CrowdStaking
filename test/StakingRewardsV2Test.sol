...
contract StakingRewardsV2Test is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    event RewardPerYearChanged(uint oldValue, uint newValue);
    ...
    //New function in V2 for testing upgradeability
    function incrementRewards() public onlyOwner {
        uint oldValue = rewardPerYear;
        rewardPerYear += 1;
        emit RewardPerYearChanged(oldValue, rewardPerYear);
    }
